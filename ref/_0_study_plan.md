...
```
        ...
        │ Day 7   │ Example XR Regression Investigation Scenario   │
        └─────────┴────────────────────────────────────────────────┘
```
...
### Day 7: Example Real-life Testing Scenario

* Build complete workflow to investigate a Regression reported by the Runtime team by designing end-to-end validation pipeline.
